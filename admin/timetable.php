                        ...
                        <tbody style="font-size: small">
                            ...
                            ?>
                                <tr>
                                    ...
                                    $days = ['monday', 'tuesday', 'wedensday', 'thursday', 'friday', 'saturday', 'sunday'];
                                    foreach ($days as $day) {
                                        $querry = mysqli_query($db_conn, "SELECT * FROM posts as p INNER JOIN metadata as md ON (md.item_id = p.id) INNER JOIN metadata as mp ON (mp.item_id = p.id) WHERE p.type = 'timetable' AND p.status = 'publish' AND md.meta_key = 'day_name' AND md.meta_value='$day' AND mp.meta_key = 'period_id' AND mp.meta_value=$period->id");
