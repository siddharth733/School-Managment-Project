    ...
    <div class="row text-white mt-3">
        ...
        while ($result = mysqli_fetch_object($querry)) { ?>
            <div class="col-12 bg-dark mb-4 border border-white rounded p-3 shadow" style="background-color: #0005;">
                    <img src="./uploads/<?= $result->image ?>" alt="" class="rounded-circle border border-white position-relative mt-2" width="100" height="100">
                    <h6 class="mt-2"><b><?= $result->name ?></b></h6>
                    <h6><?= $result->category ?></h6>
                    <div class="p-4 text-left"><?= $result->detail ?></div>
            </div>
        <?php } ?>
    </div>
</div>
